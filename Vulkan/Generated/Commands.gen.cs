...
namespace Vulkan
{
    public static unsafe partial class VulkanNative
    {
        ...
        [Generator.CalliRewrite]
        public static unsafe void vkCmdResetEvent2(VkCommandBuffer commandBuffer, VkEvent @event, VkPipelineStageFlags2 stageMask)
        {
            throw VulkanNative.CreateUnpatchedException();
        }
        ...
        [Generator.CalliRewrite]
        public static unsafe void vkCmdWriteTimestamp2(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query)
        {
            throw VulkanNative.CreateUnpatchedException();
        }
        ...
        {
            vkAcquireNextImageKHR_ptr = LoadStaticProcAddr("vkAcquireNextImageKHR");
            vkAllocateCommandBuffers_ptr = LoadStaticProcAddr("vkAllocateCommandBuffers");
            vkAllocateDescriptorSets_ptr = LoadStaticProcAddr("vkAllocateDescriptorSets");
            vkAllocateMemory_ptr = LoadStaticProcAddr("vkAllocateMemory");
            vkBeginCommandBuffer_ptr = LoadStaticProcAddr("vkBeginCommandBuffer");
            vkBindBufferMemory_ptr = LoadStaticProcAddr("vkBindBufferMemory");
            vkBindBufferMemory2_ptr = LoadStaticProcAddr("vkBindBufferMemory2");
            vkBindImageMemory_ptr = LoadStaticProcAddr("vkBindImageMemory");
            vkBindImageMemory2_ptr = LoadStaticProcAddr("vkBindImageMemory2");
            vkCmdBeginQuery_ptr = LoadStaticProcAddr("vkCmdBeginQuery");
            vkCmdBeginRendering_ptr = LoadStaticProcAddr("vkCmdBeginRendering");
            vkCmdBeginRenderPass_ptr = LoadStaticProcAddr("vkCmdBeginRenderPass");
            vkCmdBeginRenderPass2_ptr = LoadStaticProcAddr("vkCmdBeginRenderPass2");
            vkCmdBindDescriptorSets_ptr = LoadStaticProcAddr("vkCmdBindDescriptorSets");
            vkCmdBindIndexBuffer_ptr = LoadStaticProcAddr("vkCmdBindIndexBuffer");
            vkCmdBindPipeline_ptr = LoadStaticProcAddr("vkCmdBindPipeline");
            vkCmdBindVertexBuffers_ptr = LoadStaticProcAddr("vkCmdBindVertexBuffers");
            vkCmdBindVertexBuffers2_ptr = LoadStaticProcAddr("vkCmdBindVertexBuffers2");
            vkCmdBlitImage_ptr = LoadStaticProcAddr("vkCmdBlitImage");
            vkCmdBlitImage2_ptr = LoadStaticProcAddr("vkCmdBlitImage2");
            vkCmdClearAttachments_ptr = LoadStaticProcAddr("vkCmdClearAttachments");
            vkCmdClearColorImage_ptr = LoadStaticProcAddr("vkCmdClearColorImage");
            vkCmdClearDepthStencilImage_ptr = LoadStaticProcAddr("vkCmdClearDepthStencilImage");
            vkCmdCopyBuffer_ptr = LoadStaticProcAddr("vkCmdCopyBuffer");
            vkCmdCopyBuffer2_ptr = LoadStaticProcAddr("vkCmdCopyBuffer2");
            vkCmdCopyBufferToImage_ptr = LoadStaticProcAddr("vkCmdCopyBufferToImage");
            vkCmdCopyBufferToImage2_ptr = LoadStaticProcAddr("vkCmdCopyBufferToImage2");
            vkCmdCopyImage_ptr = LoadStaticProcAddr("vkCmdCopyImage");
            vkCmdCopyImage2_ptr = LoadStaticProcAddr("vkCmdCopyImage2");
            vkCmdCopyImageToBuffer_ptr = LoadStaticProcAddr("vkCmdCopyImageToBuffer");
            vkCmdCopyImageToBuffer2_ptr = LoadStaticProcAddr("vkCmdCopyImageToBuffer2");
            vkCmdCopyQueryPoolResults_ptr = LoadStaticProcAddr("vkCmdCopyQueryPoolResults");
            vkCmdDispatch_ptr = LoadStaticProcAddr("vkCmdDispatch");
            vkCmdDispatchBase_ptr = LoadStaticProcAddr("vkCmdDispatchBase");
            vkCmdDispatchIndirect_ptr = LoadStaticProcAddr("vkCmdDispatchIndirect");
            vkCmdDraw_ptr = LoadStaticProcAddr("vkCmdDraw");
            vkCmdDrawIndexed_ptr = LoadStaticProcAddr("vkCmdDrawIndexed");
            vkCmdDrawIndexedIndirect_ptr = LoadStaticProcAddr("vkCmdDrawIndexedIndirect");
            vkCmdDrawIndexedIndirectCount_ptr = LoadStaticProcAddr("vkCmdDrawIndexedIndirectCount");
            vkCmdDrawIndirect_ptr = LoadStaticProcAddr("vkCmdDrawIndirect");
            vkCmdDrawIndirectCount_ptr = LoadStaticProcAddr("vkCmdDrawIndirectCount");
            vkCmdEndQuery_ptr = LoadStaticProcAddr("vkCmdEndQuery");
            vkCmdEndRendering_ptr = LoadStaticProcAddr("vkCmdEndRendering");
            vkCmdEndRenderPass_ptr = LoadStaticProcAddr("vkCmdEndRenderPass");
            vkCmdEndRenderPass2_ptr = LoadStaticProcAddr("vkCmdEndRenderPass2");
            vkCmdExecuteCommands_ptr = LoadStaticProcAddr("vkCmdExecuteCommands");
            vkCmdFillBuffer_ptr = LoadStaticProcAddr("vkCmdFillBuffer");
            vkCmdNextSubpass_ptr = LoadStaticProcAddr("vkCmdNextSubpass");
            vkCmdNextSubpass2_ptr = LoadStaticProcAddr("vkCmdNextSubpass2");
            vkCmdPipelineBarrier_ptr = LoadStaticProcAddr("vkCmdPipelineBarrier");
            vkCmdPipelineBarrier2_ptr = LoadStaticProcAddr("vkCmdPipelineBarrier2");
            vkCmdPushConstants_ptr = LoadStaticProcAddr("vkCmdPushConstants");
            vkCmdResetEvent_ptr = LoadStaticProcAddr("vkCmdResetEvent");
            vkCmdResetEvent2_ptr = LoadStaticProcAddr("vkCmdResetEvent2");
            vkCmdResetQueryPool_ptr = LoadStaticProcAddr("vkCmdResetQueryPool");
            vkCmdResolveImage_ptr = LoadStaticProcAddr("vkCmdResolveImage");
            vkCmdResolveImage2_ptr = LoadStaticProcAddr("vkCmdResolveImage2");
            vkCmdSetBlendConstants_ptr = LoadStaticProcAddr("vkCmdSetBlendConstants");
            vkCmdSetCullMode_ptr = LoadStaticProcAddr("vkCmdSetCullMode");
            vkCmdSetDepthBias_ptr = LoadStaticProcAddr("vkCmdSetDepthBias");
            vkCmdSetDepthBiasEnable_ptr = LoadStaticProcAddr("vkCmdSetDepthBiasEnable");
            vkCmdSetDepthBounds_ptr = LoadStaticProcAddr("vkCmdSetDepthBounds");
            vkCmdSetDepthBoundsTestEnable_ptr = LoadStaticProcAddr("vkCmdSetDepthBoundsTestEnable");
            vkCmdSetDepthCompareOp_ptr = LoadStaticProcAddr("vkCmdSetDepthCompareOp");
            vkCmdSetDepthTestEnable_ptr = LoadStaticProcAddr("vkCmdSetDepthTestEnable");
            vkCmdSetDepthWriteEnable_ptr = LoadStaticProcAddr("vkCmdSetDepthWriteEnable");
            vkCmdSetDeviceMask_ptr = LoadStaticProcAddr("vkCmdSetDeviceMask");
            vkCmdSetEvent_ptr = LoadStaticProcAddr("vkCmdSetEvent");
            vkCmdSetEvent2_ptr = LoadStaticProcAddr("vkCmdSetEvent2");
            vkCmdSetFrontFace_ptr = LoadStaticProcAddr("vkCmdSetFrontFace");
            vkCmdSetLineWidth_ptr = LoadStaticProcAddr("vkCmdSetLineWidth");
            vkCmdSetPrimitiveRestartEnable_ptr = LoadStaticProcAddr("vkCmdSetPrimitiveRestartEnable");
            vkCmdSetPrimitiveTopology_ptr = LoadStaticProcAddr("vkCmdSetPrimitiveTopology");
            vkCmdSetRasterizerDiscardEnable_ptr = LoadStaticProcAddr("vkCmdSetRasterizerDiscardEnable");
            vkCmdSetScissor_ptr = LoadStaticProcAddr("vkCmdSetScissor");
            vkCmdSetScissorWithCount_ptr = LoadStaticProcAddr("vkCmdSetScissorWithCount");
            vkCmdSetStencilCompareMask_ptr = LoadStaticProcAddr("vkCmdSetStencilCompareMask");
            vkCmdSetStencilOp_ptr = LoadStaticProcAddr("vkCmdSetStencilOp");
            vkCmdSetStencilReference_ptr = LoadStaticProcAddr("vkCmdSetStencilReference");
            vkCmdSetStencilTestEnable_ptr = LoadStaticProcAddr("vkCmdSetStencilTestEnable");
            vkCmdSetStencilWriteMask_ptr = LoadStaticProcAddr("vkCmdSetStencilWriteMask");
            vkCmdSetViewport_ptr = LoadStaticProcAddr("vkCmdSetViewport");
            vkCmdSetViewportWithCount_ptr = LoadStaticProcAddr("vkCmdSetViewportWithCount");
            vkCmdUpdateBuffer_ptr = LoadStaticProcAddr("vkCmdUpdateBuffer");
            vkCmdWaitEvents_ptr = LoadStaticProcAddr("vkCmdWaitEvents");
            vkCmdWaitEvents2_ptr = LoadStaticProcAddr("vkCmdWaitEvents2");
            vkCmdWriteTimestamp_ptr = LoadStaticProcAddr("vkCmdWriteTimestamp");
            vkCmdWriteTimestamp2_ptr = LoadStaticProcAddr("vkCmdWriteTimestamp2");
            vkCreateBuffer_ptr = LoadStaticProcAddr("vkCreateBuffer");
            vkCreateBufferView_ptr = LoadStaticProcAddr("vkCreateBufferView");
            vkCreateCommandPool_ptr = LoadStaticProcAddr("vkCreateCommandPool");
            vkCreateComputePipelines_ptr = LoadStaticProcAddr("vkCreateComputePipelines");
            vkCreateDescriptorPool_ptr = LoadStaticProcAddr("vkCreateDescriptorPool");
            vkCreateDescriptorSetLayout_ptr = LoadStaticProcAddr("vkCreateDescriptorSetLayout");
            vkCreateDescriptorUpdateTemplate_ptr = LoadStaticProcAddr("vkCreateDescriptorUpdateTemplate");
            vkCreateDevice_ptr = LoadStaticProcAddr("vkCreateDevice");
            vkCreateDisplayModeKHR_ptr = LoadStaticProcAddr("vkCreateDisplayModeKHR");
            vkCreateDisplayPlaneSurfaceKHR_ptr = LoadStaticProcAddr("vkCreateDisplayPlaneSurfaceKHR");
            vkCreateEvent_ptr = LoadStaticProcAddr("vkCreateEvent");
            vkCreateFence_ptr = LoadStaticProcAddr("vkCreateFence");
            vkCreateFramebuffer_ptr = LoadStaticProcAddr("vkCreateFramebuffer");
            vkCreateGraphicsPipelines_ptr = LoadStaticProcAddr("vkCreateGraphicsPipelines");
            vkCreateImage_ptr = LoadStaticProcAddr("vkCreateImage");
            vkCreateImageView_ptr = LoadStaticProcAddr("vkCreateImageView");
            vkCreateInstance_ptr = LoadStaticProcAddr("vkCreateInstance");
            vkCreateMacOSSurfaceMVK_ptr = LoadStaticProcAddr("vkCreateMacOSSurfaceMVK");
            vkCreatePipelineCache_ptr = LoadStaticProcAddr("vkCreatePipelineCache");
            vkCreatePipelineLayout_ptr = LoadStaticProcAddr("vkCreatePipelineLayout");
            vkCreatePrivateDataSlot_ptr = LoadStaticProcAddr("vkCreatePrivateDataSlot");
            vkCreateQueryPool_ptr = LoadStaticProcAddr("vkCreateQueryPool");
            vkCreateRenderPass_ptr = LoadStaticProcAddr("vkCreateRenderPass");
            vkCreateRenderPass2_ptr = LoadStaticProcAddr("vkCreateRenderPass2");
            vkCreateSampler_ptr = LoadStaticProcAddr("vkCreateSampler");
            vkCreateSamplerYcbcrConversion_ptr = LoadStaticProcAddr("vkCreateSamplerYcbcrConversion");
            vkCreateScreenSurfaceQNX_ptr = LoadStaticProcAddr("vkCreateScreenSurfaceQNX");
            vkCreateSemaphore_ptr = LoadStaticProcAddr("vkCreateSemaphore");
            vkCreateShaderModule_ptr = LoadStaticProcAddr("vkCreateShaderModule");
            vkCreateSwapchainKHR_ptr = LoadStaticProcAddr("vkCreateSwapchainKHR");
            vkCreateWaylandSurfaceKHR_ptr = LoadStaticProcAddr("vkCreateWaylandSurfaceKHR");
            vkCreateWin32SurfaceKHR_ptr = LoadStaticProcAddr("vkCreateWin32SurfaceKHR");
            vkCreateXcbSurfaceKHR_ptr = LoadStaticProcAddr("vkCreateXcbSurfaceKHR");
            vkCreateXlibSurfaceKHR_ptr = LoadStaticProcAddr("vkCreateXlibSurfaceKHR");
            vkDestroyBuffer_ptr = LoadStaticProcAddr("vkDestroyBuffer");
            vkDestroyBufferView_ptr = LoadStaticProcAddr("vkDestroyBufferView");
            vkDestroyCommandPool_ptr = LoadStaticProcAddr("vkDestroyCommandPool");
            vkDestroyDescriptorPool_ptr = LoadStaticProcAddr("vkDestroyDescriptorPool");
            vkDestroyDescriptorSetLayout_ptr = LoadStaticProcAddr("vkDestroyDescriptorSetLayout");
            vkDestroyDescriptorUpdateTemplate_ptr = LoadStaticProcAddr("vkDestroyDescriptorUpdateTemplate");
            vkDestroyDevice_ptr = LoadStaticProcAddr("vkDestroyDevice");
            vkDestroyEvent_ptr = LoadStaticProcAddr("vkDestroyEvent");
            vkDestroyFence_ptr = LoadStaticProcAddr("vkDestroyFence");
            vkDestroyFramebuffer_ptr = LoadStaticProcAddr("vkDestroyFramebuffer");
            vkDestroyImage_ptr = LoadStaticProcAddr("vkDestroyImage");
            vkDestroyImageView_ptr = LoadStaticProcAddr("vkDestroyImageView");
            vkDestroyInstance_ptr = LoadStaticProcAddr("vkDestroyInstance");
            vkDestroyPipeline_ptr = LoadStaticProcAddr("vkDestroyPipeline");
            vkDestroyPipelineCache_ptr = LoadStaticProcAddr("vkDestroyPipelineCache");
            vkDestroyPipelineLayout_ptr = LoadStaticProcAddr("vkDestroyPipelineLayout");
            vkDestroyPrivateDataSlot_ptr = LoadStaticProcAddr("vkDestroyPrivateDataSlot");
            vkDestroyQueryPool_ptr = LoadStaticProcAddr("vkDestroyQueryPool");
            vkDestroyRenderPass_ptr = LoadStaticProcAddr("vkDestroyRenderPass");
            vkDestroySampler_ptr = LoadStaticProcAddr("vkDestroySampler");
            vkDestroySamplerYcbcrConversion_ptr = LoadStaticProcAddr("vkDestroySamplerYcbcrConversion");
            vkDestroySemaphore_ptr = LoadStaticProcAddr("vkDestroySemaphore");
            vkDestroyShaderModule_ptr = LoadStaticProcAddr("vkDestroyShaderModule");
            vkDestroySurfaceKHR_ptr = LoadStaticProcAddr("vkDestroySurfaceKHR");
            vkDestroySwapchainKHR_ptr = LoadStaticProcAddr("vkDestroySwapchainKHR");
            vkDeviceWaitIdle_ptr = LoadStaticProcAddr("vkDeviceWaitIdle");
            vkEndCommandBuffer_ptr = LoadStaticProcAddr("vkEndCommandBuffer");
            vkEnumerateDeviceExtensionProperties_ptr = LoadStaticProcAddr("vkEnumerateDeviceExtensionProperties");
            vkEnumerateDeviceLayerProperties_ptr = LoadStaticProcAddr("vkEnumerateDeviceLayerProperties");
            vkEnumerateInstanceExtensionProperties_ptr = LoadStaticProcAddr("vkEnumerateInstanceExtensionProperties");
            vkEnumerateInstanceLayerProperties_ptr = LoadStaticProcAddr("vkEnumerateInstanceLayerProperties");
            vkEnumerateInstanceVersion_ptr = LoadStaticProcAddr("vkEnumerateInstanceVersion");
            vkEnumeratePhysicalDeviceGroups_ptr = LoadStaticProcAddr("vkEnumeratePhysicalDeviceGroups");
            vkEnumeratePhysicalDevices_ptr = LoadStaticProcAddr("vkEnumeratePhysicalDevices");
            vkFlushMappedMemoryRanges_ptr = LoadStaticProcAddr("vkFlushMappedMemoryRanges");
            vkFreeCommandBuffers_ptr = LoadStaticProcAddr("vkFreeCommandBuffers");
            vkFreeDescriptorSets_ptr = LoadStaticProcAddr("vkFreeDescriptorSets");
            vkFreeMemory_ptr = LoadStaticProcAddr("vkFreeMemory");
            vkGetBufferDeviceAddress_ptr = LoadStaticProcAddr("vkGetBufferDeviceAddress");
            vkGetBufferMemoryRequirements_ptr = LoadStaticProcAddr("vkGetBufferMemoryRequirements");
            vkGetBufferMemoryRequirements2_ptr = LoadStaticProcAddr("vkGetBufferMemoryRequirements2");
            vkGetBufferOpaqueCaptureAddress_ptr = LoadStaticProcAddr("vkGetBufferOpaqueCaptureAddress");
            vkGetDescriptorSetLayoutSupport_ptr = LoadStaticProcAddr("vkGetDescriptorSetLayoutSupport");
            vkGetDeviceBufferMemoryRequirements_ptr = LoadStaticProcAddr("vkGetDeviceBufferMemoryRequirements");
            vkGetDeviceGroupPeerMemoryFeatures_ptr = LoadStaticProcAddr("vkGetDeviceGroupPeerMemoryFeatures");
            vkGetDeviceImageMemoryRequirements_ptr = LoadStaticProcAddr("vkGetDeviceImageMemoryRequirements");
            vkGetDeviceImageSparseMemoryRequirements_ptr = LoadStaticProcAddr("vkGetDeviceImageSparseMemoryRequirements");
            vkGetDeviceMemoryCommitment_ptr = LoadStaticProcAddr("vkGetDeviceMemoryCommitment");
            vkGetDeviceMemoryOpaqueCaptureAddress_ptr = LoadStaticProcAddr("vkGetDeviceMemoryOpaqueCaptureAddress");
            vkGetDeviceProcAddr_ptr = LoadStaticProcAddr("vkGetDeviceProcAddr");
            vkGetDeviceQueue_ptr = LoadStaticProcAddr("vkGetDeviceQueue");
            vkGetDeviceQueue2_ptr = LoadStaticProcAddr("vkGetDeviceQueue2");
            vkGetDisplayModePropertiesKHR_ptr = LoadStaticProcAddr("vkGetDisplayModePropertiesKHR");
            vkGetDisplayPlaneCapabilitiesKHR_ptr = LoadStaticProcAddr("vkGetDisplayPlaneCapabilitiesKHR");
            vkGetDisplayPlaneSupportedDisplaysKHR_ptr = LoadStaticProcAddr("vkGetDisplayPlaneSupportedDisplaysKHR");
            vkGetEventStatus_ptr = LoadStaticProcAddr("vkGetEventStatus");
            vkGetFenceStatus_ptr = LoadStaticProcAddr("vkGetFenceStatus");
            vkGetImageMemoryRequirements_ptr = LoadStaticProcAddr("vkGetImageMemoryRequirements");
            vkGetImageMemoryRequirements2_ptr = LoadStaticProcAddr("vkGetImageMemoryRequirements2");
            vkGetImageSparseMemoryRequirements_ptr = LoadStaticProcAddr("vkGetImageSparseMemoryRequirements");
            vkGetImageSparseMemoryRequirements2_ptr = LoadStaticProcAddr("vkGetImageSparseMemoryRequirements2");
            vkGetImageSubresourceLayout_ptr = LoadStaticProcAddr("vkGetImageSubresourceLayout");
            vkGetInstanceProcAddr_ptr = LoadStaticProcAddr("vkGetInstanceProcAddr");
            vkGetPhysicalDeviceDisplayPlanePropertiesKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceDisplayPlanePropertiesKHR");
            vkGetPhysicalDeviceDisplayPropertiesKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceDisplayPropertiesKHR");
            vkGetPhysicalDeviceExternalBufferProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceExternalBufferProperties");
            vkGetPhysicalDeviceExternalFenceProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceExternalFenceProperties");
            vkGetPhysicalDeviceExternalSemaphoreProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceExternalSemaphoreProperties");
            vkGetPhysicalDeviceFeatures_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceFeatures");
            vkGetPhysicalDeviceFeatures2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceFeatures2");
            vkGetPhysicalDeviceFormatProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceFormatProperties");
            vkGetPhysicalDeviceFormatProperties2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceFormatProperties2");
            vkGetPhysicalDeviceImageFormatProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceImageFormatProperties");
            vkGetPhysicalDeviceImageFormatProperties2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceImageFormatProperties2");
            vkGetPhysicalDeviceMemoryProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceMemoryProperties");
            vkGetPhysicalDeviceMemoryProperties2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceMemoryProperties2");
            vkGetPhysicalDeviceProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceProperties");
            vkGetPhysicalDeviceProperties2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceProperties2");
            vkGetPhysicalDeviceQueueFamilyProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceQueueFamilyProperties");
            vkGetPhysicalDeviceQueueFamilyProperties2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceQueueFamilyProperties2");
            vkGetPhysicalDeviceScreenPresentationSupportQNX_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceScreenPresentationSupportQNX");
            vkGetPhysicalDeviceSparseImageFormatProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceSparseImageFormatProperties");
            vkGetPhysicalDeviceSparseImageFormatProperties2_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceSparseImageFormatProperties2");
            vkGetPhysicalDeviceSurfaceCapabilitiesKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
            vkGetPhysicalDeviceSurfaceFormatsKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceSurfaceFormatsKHR");
            vkGetPhysicalDeviceSurfacePresentModesKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceSurfacePresentModesKHR");
            vkGetPhysicalDeviceSurfaceSupportKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceSurfaceSupportKHR");
            vkGetPhysicalDeviceToolProperties_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceToolProperties");
            vkGetPhysicalDeviceWaylandPresentationSupportKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceWaylandPresentationSupportKHR");
            vkGetPhysicalDeviceWin32PresentationSupportKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceWin32PresentationSupportKHR");
            vkGetPhysicalDeviceXcbPresentationSupportKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceXcbPresentationSupportKHR");
            vkGetPhysicalDeviceXlibPresentationSupportKHR_ptr = LoadStaticProcAddr("vkGetPhysicalDeviceXlibPresentationSupportKHR");
            vkGetPipelineCacheData_ptr = LoadStaticProcAddr("vkGetPipelineCacheData");
            vkGetPrivateData_ptr = LoadStaticProcAddr("vkGetPrivateData");
            vkGetQueryPoolResults_ptr = LoadStaticProcAddr("vkGetQueryPoolResults");
            vkGetRenderAreaGranularity_ptr = LoadStaticProcAddr("vkGetRenderAreaGranularity");
            vkGetSemaphoreCounterValue_ptr = LoadStaticProcAddr("vkGetSemaphoreCounterValue");
            vkGetSwapchainImagesKHR_ptr = LoadStaticProcAddr("vkGetSwapchainImagesKHR");
            vkInvalidateMappedMemoryRanges_ptr = LoadStaticProcAddr("vkInvalidateMappedMemoryRanges");
            vkMapMemory_ptr = LoadStaticProcAddr("vkMapMemory");
            vkMergePipelineCaches_ptr = LoadStaticProcAddr("vkMergePipelineCaches");
            vkQueueBindSparse_ptr = LoadStaticProcAddr("vkQueueBindSparse");
            vkQueuePresentKHR_ptr = LoadStaticProcAddr("vkQueuePresentKHR");
            vkQueueSubmit_ptr = LoadStaticProcAddr("vkQueueSubmit");
            vkQueueSubmit2_ptr = LoadStaticProcAddr("vkQueueSubmit2");
            vkQueueWaitIdle_ptr = LoadStaticProcAddr("vkQueueWaitIdle");
            vkResetCommandBuffer_ptr = LoadStaticProcAddr("vkResetCommandBuffer");
            vkResetCommandPool_ptr = LoadStaticProcAddr("vkResetCommandPool");
            vkResetDescriptorPool_ptr = LoadStaticProcAddr("vkResetDescriptorPool");
            vkResetEvent_ptr = LoadStaticProcAddr("vkResetEvent");
            vkResetFences_ptr = LoadStaticProcAddr("vkResetFences");
            vkResetQueryPool_ptr = LoadStaticProcAddr("vkResetQueryPool");
            vkSetEvent_ptr = LoadStaticProcAddr("vkSetEvent");
            vkSetPrivateData_ptr = LoadStaticProcAddr("vkSetPrivateData");
            vkSignalSemaphore_ptr = LoadStaticProcAddr("vkSignalSemaphore");
            vkTrimCommandPool_ptr = LoadStaticProcAddr("vkTrimCommandPool");
            vkUnmapMemory_ptr = LoadStaticProcAddr("vkUnmapMemory");
            vkUpdateDescriptorSets_ptr = LoadStaticProcAddr("vkUpdateDescriptorSets");
            vkUpdateDescriptorSetWithTemplate_ptr = LoadStaticProcAddr("vkUpdateDescriptorSetWithTemplate");
            vkWaitForFences_ptr = LoadStaticProcAddr("vkWaitForFences");
            vkWaitSemaphores_ptr = LoadStaticProcAddr("vkWaitSemaphores");
        }
    }
}
